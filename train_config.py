...
config.TRAIN.val_iter=config.TRAIN.val_set_size// config.TRAIN.num_gpu // config.TRAIN.batch_size #500
...
# config.DATA.train_txt_path='caltech_train1.txt'
# config.DATA.val_txt_path='caltech_val1.txt'
...
config.ANCHOR.ANCHOR_SIZES = (16,32,64, 128, 256, 512)   # sqrt area of the anchor box
...
config.MODEL.continue_train=False ### revover from a trained model
config.MODEL.model_path = './caltech_model/'  # save directory
